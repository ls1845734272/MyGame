...
{
    public static string luaDir = Application.dataPath + "/FXGame/Lua";                //lua逻辑代码目录
    public static string toluaDir = Application.dataPath + "/FXGame/ToLua/Lua";        //tolua lua文件目录
