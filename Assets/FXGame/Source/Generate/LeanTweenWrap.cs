...
public class LeanTweenWrap
{
	...
	static int alpha(IntPtr L)
	{
		try
		{
			...
			if (count == 3 && TypeChecker.CheckTypes<UnityEngine.RectTransform, float, float>(L, 1))
			{
			...
			else if (count == 3 && TypeChecker.CheckTypes<UnityEngine.GameObject, float, float>(L, 1))
			{
				UnityEngine.GameObject arg0 = (UnityEngine.GameObject)ToLua.ToObject(L, 1);
				float arg1 = (float)LuaDLL.lua_tonumber(L, 2);
				float arg2 = (float)LuaDLL.lua_tonumber(L, 3);
	...
	static int color(IntPtr L)
	{
		try
		{
			...
			if (count == 3 && TypeChecker.CheckTypes<UnityEngine.RectTransform, UnityEngine.Color, float>(L, 1))
			{
				UnityEngine.RectTransform arg0 = (UnityEngine.RectTransform)ToLua.ToObject(L, 1);
			...
			else if (count == 3 && TypeChecker.CheckTypes<UnityEngine.GameObject, UnityEngine.Color, float>(L, 1))
			{
				UnityEngine.GameObject arg0 = (UnityEngine.GameObject)ToLua.ToObject(L, 1);
				UnityEngine.Color arg1 = ToLua.ToColor(L, 2);
				float arg2 = (float)LuaDLL.lua_tonumber(L, 3);
	...
	static int move(IntPtr L)
	{
		try
		{
			...
			if (count == 3 && TypeChecker.CheckTypes<LTRect, UnityEngine.Vector2, float>(L, 1))
			{
				LTRect arg0 = (LTRect)ToLua.ToObject(L, 1);
	...
	static int moveLocal(IntPtr L)
	{
		try
		{
			...
			if (count == 3 && TypeChecker.CheckTypes<LTBezierPath, float>(L, 2))
			{
				UnityEngine.GameObject arg0 = (UnityEngine.GameObject)ToLua.CheckObject(L, 1, typeof(UnityEngine.GameObject));
				LTBezierPath arg1 = (LTBezierPath)ToLua.ToObject(L, 2);
				float arg2 = (float)LuaDLL.lua_tonumber(L, 3);
	...
	static int rotateAround(IntPtr L)
	{
		try
		{
			...
			if (count == 4 && TypeChecker.CheckTypes<UnityEngine.RectTransform, UnityEngine.Vector3, float, float>(L, 1))
			{
				UnityEngine.RectTransform arg0 = (UnityEngine.RectTransform)ToLua.ToObject(L, 1);
				UnityEngine.Vector3 arg1 = ToLua.ToVector3(L, 2);
				float arg2 = (float)LuaDLL.lua_tonumber(L, 3);
			...
			else if (count == 4 && TypeChecker.CheckTypes<UnityEngine.GameObject, UnityEngine.Vector3, float, float>(L, 1))
			{
				UnityEngine.GameObject arg0 = (UnityEngine.GameObject)ToLua.ToObject(L, 1);
				UnityEngine.Vector3 arg1 = ToLua.ToVector3(L, 2);
				float arg2 = (float)LuaDLL.lua_tonumber(L, 3);
	...
	static int scale(IntPtr L)
	{
		try
		{
			...
			if (count == 3 && TypeChecker.CheckTypes<UnityEngine.RectTransform, UnityEngine.Vector3, float>(L, 1))
			{
				UnityEngine.RectTransform arg0 = (UnityEngine.RectTransform)ToLua.ToObject(L, 1);
				UnityEngine.Vector3 arg1 = ToLua.ToVector3(L, 2);
				float arg2 = (float)LuaDLL.lua_tonumber(L, 3);
	...
	static int value(IntPtr L)
	{
		try
		{
			...
			if (count == 4 && TypeChecker.CheckTypes<UnityEngine.Vector3, UnityEngine.Vector3, float>(L, 2))
			{
				UnityEngine.GameObject arg0 = (UnityEngine.GameObject)ToLua.CheckObject(L, 1, typeof(UnityEngine.GameObject));
				UnityEngine.Vector3 arg1 = ToLua.ToVector3(L, 2);
				UnityEngine.Vector3 arg2 = ToLua.ToVector3(L, 3);
