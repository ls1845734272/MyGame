...
public class LTDescrImplWrap
{
	...
	static int ToString(IntPtr L)
	{
		try
		{
			...
			LTDescrImpl obj = (LTDescrImpl)ToLua.CheckObject<LTDescrImpl>(L, 1);
	...
	static int setEase(IntPtr L)
	{
		try
		{
			...
			else if (count == 2 && TypeChecker.CheckTypes<LeanTweenType>(L, 2))
			{
				LTDescrImpl obj = (LTDescrImpl)ToLua.CheckObject<LTDescrImpl>(L, 1);
	...
	static int setOnComplete(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes<System.Action<object>>(L, 2))
			{
				LTDescrImpl obj = (LTDescrImpl)ToLua.CheckObject<LTDescrImpl>(L, 1);
	...
	static int setOnUpdate(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes<System.Action<float,object>>(L, 2))
			{
				LTDescrImpl obj = (LTDescrImpl)ToLua.CheckObject<LTDescrImpl>(L, 1);
			...
			else if (count == 2 && TypeChecker.CheckTypes<System.Action<float>>(L, 2))
			{
				LTDescrImpl obj = (LTDescrImpl)ToLua.CheckObject<LTDescrImpl>(L, 1);
	...
	static int setOnUpdateColor(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
			LTDescrImpl obj = (LTDescrImpl)ToLua.CheckObject<LTDescrImpl>(L, 1);
			System.Action<UnityEngine.Color> arg0 = (System.Action<UnityEngine.Color>)ToLua.CheckDelegate<System.Action<UnityEngine.Color>>(L, 2);
	...
	static int setRect(IntPtr L)
	{
		try
		{
			...
			else if (count == 2 && TypeChecker.CheckTypes<LTRect>(L, 2))
			{
				LTDescrImpl obj = (LTDescrImpl)ToLua.CheckObject<LTDescrImpl>(L, 1);
	...
	static int get_toTrans(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index toTrans on a nil value");
		}
	}
	...
	static int get_diff(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index diff on a nil value");
		}
	}
	...
	static int get_axis(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index axis on a nil value");
		}
	}
	...
	static int get_origRotation(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index origRotation on a nil value");
		}
	}
	...
	static int get_spline(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index spline on a nil value");
		}
	}
	...
	static int get_onUpdateFloat(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index onUpdateFloat on a nil value");
		}
	}
	...
	static int get_onUpdateFloatRatio(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index onUpdateFloatRatio on a nil value");
		}
	}
	...
	static int get_onUpdateFloatObject(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index onUpdateFloatObject on a nil value");
		}
	}
	...
	static int get_onUpdateVector2(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index onUpdateVector2 on a nil value");
		}
	}
	...
	static int get_onUpdateVector3(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index onUpdateVector3 on a nil value");
		}
	}
	...
	static int get_onUpdateVector3Object(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index onUpdateVector3Object on a nil value");
		}
	}
	...
	static int get_onUpdateColor(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index onUpdateColor on a nil value");
		}
	}
	...
	static int get_onCompleteObject(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index onCompleteObject on a nil value");
		}
	}
	...
	static int get_onCompleteParam(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index onCompleteParam on a nil value");
		}
	}
	...
	static int get_onUpdateParam(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index onUpdateParam on a nil value");
		}
	}
	...
	static int set_spline(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			LTDescrImpl obj = (LTDescrImpl)o;
			LTSpline arg0 = (LTSpline)ToLua.CheckObject<LTSpline>(L, 2);
			obj.spline = arg0;
			return 0;
		}
		catch(Exception e)
	...
	static int set_onUpdateVector3Object(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			LTDescrImpl obj = (LTDescrImpl)o;
			System.Action<UnityEngine.Vector3,object> arg0 = (System.Action<UnityEngine.Vector3,object>)ToLua.CheckDelegate<System.Action<UnityEngine.Vector3,object>>(L, 2);
