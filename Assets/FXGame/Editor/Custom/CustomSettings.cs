...
{
    public static string saveDir = Application.dataPath + "/FXGame/Source/Generate/";    
    public static string toluaBaseType = Application.dataPath + "/FXGame/ToLua/BaseType/";    
    ...
    public static DelegateType[] customDelegateList = 
    {
        ...
        _DT(typeof(UnityEngine.UI.InputField.OnValidateInput)),
    };
    ...
    {                
        ...
        //-------------------------------------------------------------------        
         ...
         //_GT(typeof(Manager<ResourceManager>)),

         //MyGame
         _GT(typeof(AppConst)),
         _GT(typeof(LuaUtil)),
         _GT(typeof(FXBehaviour)),
         _GT(typeof(LuaBehaviour)),
         _GT(typeof(Util)),
         _GT(typeof(UnityEngine.CanvasGroup)),

         //排序
         _GT(typeof(SortingOrder)),
         ...
         _GT(typeof(GradientEffect)),

         _GT(typeof(UICameraFog)),
...
//#endif
       ...
       // _GT(typeof(UnityEngine.EventSystems.TouchInputModule)) 接口过时,
